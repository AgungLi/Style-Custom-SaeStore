                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Form edit Logo</h1>
                            </div>
                            <?php
                            //notifikasi error
                            ...
                            <div class="form-group">
                                <label for="">Upload Logo Baru</label>
                                <input type="file" name="logo" class="form-control" placeholder="Upload Logo Baru" value="<?php echo $konfigurasi->logo ?>" required>
                                Logo Lama : <br> <img src="<?php echo base_url('assets/upload/image/' . $konfigurasi->logo) ?>" alt="" class="img img-responsive img-thumbnail" width="200">
                            </div>
