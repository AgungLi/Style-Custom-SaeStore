                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Form Tambah produk</h1>
                            </div>
                            <?php
                            //notifikasi error
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="keterangan" class="form-control" placeholder="Keterangan" value="<?php echo set_value('keterangan') ?>" id="editor"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="">Keyword (Untuk SEO Google)</label>
                                <textarea name="keyword" class="form-control" placeholder="keyword" value="<?php echo set_value('keyword') ?>"></textarea>
                            </div>
                            <div class="form-group">
