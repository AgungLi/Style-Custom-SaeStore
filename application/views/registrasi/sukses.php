            ...
            <div class="col-md-12 ftco-animate">
                <div class="cart-list">
                    ...
                    <p class="alert alert-dark">
                        ...
                        <a href="<?php echo base_url('masuk') ?>" class="btn btn-dark btn-sm">
                            Login disini
                        </a>.
                        Anda dapat melakukan check out
                        <a href="<?php echo base_url('belanja/checkout') ?>" class="btn btn-dark btn-sm">
